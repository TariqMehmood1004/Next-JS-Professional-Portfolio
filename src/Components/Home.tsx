  ...
  return (
    <section className="w-full md:h-screen">
        ...
        >
            ...
            className="absolute left-8 md:left-[50%] top-60 md:top-50 text-lg md:text-4xl border-2 border-[#171717] rounded-lg p-4 px-6 font-medium bg-[#171717] text-white hover:bg-[#272727] hover:text-white transition-all duration-300 uppercase"
            >
            Download Resume
            </Link>
        </motion.section>
