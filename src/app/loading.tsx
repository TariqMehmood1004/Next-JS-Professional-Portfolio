...
const Loader = () => {
  return (
    <section className='fixed top-0 left-0 p-0 md:p-16 w-full h-full bg-[var(--primary)] z-50 flex items-center justify-center'>
        <div className='relative w-full h-full bg-[var(--yellow)] md:rounded-4xl p-12'>
            ...
            <div className="flex items-center gap-1">             
              <div className="w-[50px] md:w-[70px]">
                <Image
                  ...
                  width={60}
                  height={60}
                  className='rounded-full w-12 h-12 md:w-16 md:h-16 object-cover bg-[var(--yellow)]'
                  priority
                />
              </div>
              <div className="text-white text-2xl md:text-4xl font-bold">Portfolio</div>
          ...
          <div className="flex items-center justify-center">
            ...
            <motion.div
              ...
              className="flex items-center absolute top-[39%] md:top-[47%] left-[47%] transform -translate-x-[50%] -translate-y-[50%] -rotate-[55deg] h-16 px-3 rounded-full bg-black overflow-hidden"
            ></motion.div>
            ...
            <motion.div
              ...
              className="flex items-center absolute top-[60%] md:top-[50%] left-[54%] transform -translate-x-[50%] -translate-y-[50%] -rotate-[55deg] h-16 px-3 rounded-full bg-black overflow-hidden"
            ></motion.div>
          </div>
