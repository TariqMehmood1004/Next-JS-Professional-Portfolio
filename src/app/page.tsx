    ...
    >
      <section>
        <header className="w-full p-8 flex md:flex-row flex-col justify-between items-center gap-10">
          <div className="w-full flex flex-col md:flex-row gap-10 items-center">
            ...
            <Link
              href="/"
              className="text-2xl transition-all duration-300 md:text-4xl font-medium text-neutral-600 hover:text-[#474747] uppercase"
            >
              johnbrrighte@engineer.com
            </Link>
          </div>

          <div className="w-full cursor-pointer text-2xl md:text-3xl p-3 px-6 flex gap-10 items-center font-normal text-neutral-500 hover:text-[#474747] uppercase transition-all duration-300">
      ...
      >
        <Link
          ...
          className="text-2xl md:text-4xl border-2 border-[#171717] rounded-full p-4 px-6 font-medium hover:bg-[#171717] hover:text-white transition-all duration-300 uppercase"
        >
          Creative Developer
        </Link>
        <Link
          ...
          className="absolute left-[35%] top-20 text-2xl md:text-4xl border-2 border-[#171717] rounded-lg p-4 px-6 font-medium hover:bg-[#171717] hover:text-white transition-all duration-300 uppercase"
        >
          GitHub
        </Link>
        <Link
          ...
          className="absolute left-[45%] top-40 md:top-28 text-2xl md:text-4xl border-2 border-[#171717] rounded-lg p-4 px-6 font-medium hover:bg-[#171717] hover:text-white transition-all duration-300 uppercase"
        >
          LinkedIn
        </Link>
        <Link
          target="_blank"
          href="https://www.linkedin.com/in/tariq-mehmood-3ab013254/"
          className="absolute left-8 md:left-[50%] top-60 md:top-50 text-2xl md:text-4xl border-2 border-[#171717] rounded-lg p-4 px-6 font-medium bg-[#272727] text-white hover:bg-[#373737] hover:text-white transition-all duration-300 uppercase"
        >
          Download Resume
        </Link>
      </motion.section>
      ...
      >
        <div className="w-full flex flex-col justify-center items-center gap-5">
          ...
          <p className="text-lg text-center md:text-left font-normal px-0 md:px-10">
